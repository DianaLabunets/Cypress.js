describe('Покупка аватара', function () {                 // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.get('input[id="k_email"]').type('DianaOlenikova-Labunets@yandex.ru');                   // вводим логин
         cy.get('input[id="k_password"]').type('Di030920');               // вводим пароль
         ...
         cy.get('.card_date').type('10/25');                           // вводим срок действия карты
